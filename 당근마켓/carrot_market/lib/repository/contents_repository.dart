...
class ContentRepository extends LoalStorageRepository{
  ...
  Map<String, dynamic> datas = {
    ...
    "ora": [
      {
        "cid": "11",
        "image": "assets/images/ora-1.jpeg",
      ...
      {
        "cid": "12",
        "image": "assets/images/ora-2.jpeg",
      ...
      {
        "cid": "13",
        "image": "assets/images/ora-3.jpeg",
        "title": "브리츠 컴퓨터용 스피커",
        "location": "제주 제주시 오라동",
        "price": "1000",
        "likes": "4"
      ...
      {
        "cid": "14",
        "image": "assets/images/ora-4.jpeg",
        "title": "안락 의자",
        "location": "제주 제주시 오라동",
        "price": "10000",
        "likes": "1"
      ...
      {
        "cid": "15",
        "image": "assets/images/ora-5.jpeg",
        "title": "어린이책 무료드림",
        "location": "제주 제주시 오라동",
        "price": "무료나눔",
        "likes": "1"
      ...
      {
        "cid": "16",
        "image": "assets/images/ora-6.jpeg",
        "title": "어린이책 무료드림",
        "location": "제주 제주시 오라동",
        "price": "무료나눔",
        "likes": "0"
      ...
      {
        "cid": "17",
        "image": "assets/images/ora-7.jpeg",
        "title": "칼세트 재제품 팝니다",
        "location": "제주 제주시 오라동",
        "price": "20000",
        "likes": "5"
      ...
      {
        "cid": "18",
        "image": "assets/images/ora-8.jpeg",
        "title": "아이팜장난감정리함팔아요",
        "location": "제주 제주시 오라동",
        "price": "30000",
        "likes": "29"
      ...
      {
        "cid": "19",
        "image": "assets/images/ora-9.jpeg",
      ...
      {
        "cid": "20",
        "image": "assets/images/ora-10.jpeg",
  ...
  void updateFavoriteContent(List favoritelist) async{
    await this.storeValue(MY_FAVORITE_KEY, jsonEncode(favoritelist));
  }
